...
namespace TradesCompany.Infrastructure.Migrations
{
    ...
    [Migration("20250729052942_add_isseen_model")]
    partial class add_isseen_model
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradesCompany.Domain.Entities.Bill", b =>
                {
                    ...
                    b.Property<int?>("serviceScheduleId1")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("serviceScheduleId1");
            ...
            modelBuilder.Entity("TradesCompany.Domain.Entities.Bill", b =>
                {
                    b.HasOne("TradesCompany.Domain.Entities.ServiceSchedule", "serviceSchedule")
                        .WithMany()
                        .HasForeignKey("serviceScheduleId1");
            ...
            modelBuilder.Entity("TradesCompany.Domain.Entities.ChannelMessage", b =>
                {
                    b.HasOne("TradesCompany.Domain.Entities.IsSeen", "IsSeen")
                        .WithMany()
                        .HasForeignKey("IsSeenId");
