        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuotationPdf = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceSchedules_Bills_BillId",
                        column: x => x.BillId,
                        principalTable: "Bills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ServiceSchedules_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceSchedules_Quotations_QuotationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_ServiceSchedules_ServiceScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_ServiceScheduleId",
                table: "Ratings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceSchedules_BillId",
                table: "ServiceSchedules",
                column: "BillId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceSchedules_BookingId",
                table: "ServiceSchedules",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceSchedules_QuotationId",
                table: "ServiceSchedules",
                column: "QuotationId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceSchedules_ServiceManId",
                table: "ServiceSchedules",
                column: "ServiceManId");
        }
